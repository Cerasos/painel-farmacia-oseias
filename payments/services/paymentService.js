class PaymentService {
  ...
  async generatePixQRCode(paymentId) {
    ...
    const pixData = {
      ...
      qrCode: `00020126580014br.gov.bcb.pix0136${paymentId}520400005303986540${payment.amount.toFixed(
        2
      )}5802BR5913FARMACIA OSEIAS6008SAO PAULO62290525${paymentId}6304E2CA`,
